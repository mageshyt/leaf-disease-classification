...
performance_df = pd.read_csv("/Volumes/Project-2/programming/machine_deep_learning/DL-project/front-end/assets/csv/performance_metrics.csv")

# 1. Precision, Recall, and F1 Score of the Machine Learning Models

st.subheader("1. Precision, Recall, and F1 Score of the Machine Learning Models")
...
st.bar_chart(performance_df,x='Model',y=['Accuracy','Precision','Recall','F1 Score'])
...
mobile_net_model=performance_df.loc[performance_df['Model'] == 'MobileNet_v2']
...
efficientnet_model = performance_df.loc[performance_df['Model'] == 'EfficientNet']
